...
from main.views import register, login_user, logout_user, add_news_entry_ajax, proxy_image, create_news_flutter
...
urlpatterns = [
    ...
    path('news/<str:id>/edit', edit_news, name='edit_news'),
